...
`euconform.aibom.v1` is the AI Bill of Materials document inside the EuConform format.
...
- the AI BOM is a **sub-document** of the EuConform format, not the umbrella specification
